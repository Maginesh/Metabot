...
export default function NavBar() {
    return (
        <header className="text-gray-600 body-font bg-pink-200 border-b border-pink-900">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                >
                    ...
                    <span className="ml-3 text-xl">Metabot</span>
                </Link>
                <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
                    <Link className="mr-5 hover:text-gray-900" to={"/addVitals"}>Add Current Vitals</Link>
                    <Link className="mr-5 hover:text-gray-900" to={"/viewRecords"}>View Records</Link>
